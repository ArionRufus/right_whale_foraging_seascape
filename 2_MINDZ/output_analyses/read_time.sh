...
#SBATCH --job-name=traj_time                 # nom de la tache à runer
#SBATCH --output=traj_time.out               # nom du fichier dans lequel on peut lire les infos d'outputs
...
#SBATCH --time=00-02:30:00                   # total run time limit (DD-HH:MM:SS)
