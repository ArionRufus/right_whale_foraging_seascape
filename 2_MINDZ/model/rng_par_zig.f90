...
contains
  ...
  end function rng_int32_to_real32
  ...
  end function rng_int64_to_real32
  ...
  end function rng_int64_to_real64

end module rng_int_to_real
...
module rng_par_zig
  ...
  end interface rng_exp

  interface rng_init
     module procedure rng_zigset
  end interface rng_init
  ...
  end interface rng_xoroshiro128plus

  interface rng_jump
     module procedure rng_jump
     module procedure rng_jump_n
  end interface rng_jump
...
contains
  ...
  end subroutine rng_xoroshiro128plus_kpar
  ...
  end subroutine rng_xoroshiro128plus_kpar_32
  ...
  end subroutine rng_xoroshiro128plus
  ...
  subroutine rng_rexp_32(x, kpar)
    ...
    x = real(x64, sp)
  end subroutine rng_rexp_32

  subroutine rng_uni_ser(x)
    real(dp), intent(out) :: x

    call rng_uni(x, 0)
  end subroutine rng_uni_ser

  subroutine rng_rnor_ser(x)
    real(dp), intent(out) :: x

    call rng_rnor(x, 0)
  end subroutine rng_rnor_ser

  subroutine rng_rexp_ser(x)
    real(dp), intent(out) :: x

    call rng_rexp(x, 0)
  end subroutine rng_rexp_ser
  ...
  subroutine rng_rnor_32_ser(x)
    ...
    call rng_rnor(x64, 0)
    x = real(x64, sp)
  end subroutine rng_rnor_32_ser
  ...
  subroutine rng_rexp_32_ser(x)
    ...
    call rng_rexp(x64, 0)
    x = real(x64, sp)
  end subroutine rng_rexp_32_ser
